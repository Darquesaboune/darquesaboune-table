        ...
        <div className="py-12">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="lg:text-center">
              ...
              <p className="mt-2 text-[color:white] text-3xl font-bold leading-8 tracking-tight text-gray-900 sm:text-4xl tracking-[1em]"><VFXSpan shader="pixelate">darquesaboune</VFXSpan></p>
